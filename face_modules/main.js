...
var canvasPatch_1 = require("./modules/canvasPatch");
var saveFile_1 = require("./modules/saveFile");
var faceOptions_1 = require("./modules/faceOptions");
var faceapi = require("face-api.js");
var startTime;
var elon = saveFile_1.readFile("elon.json");
var labeledDescriptors = [
    new faceapi.LabeledFaceDescriptors("obama", [
        new Float32Array(JSON.parse(elon.toString())),
    ]),
];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, canvasPatch_1.canvas.loadImage("./images/wa.jpeg")];
                case 4:
                    img = _a.sent();
                    return [4 /*yield*/, faceapi
                            .detectAllFaces(img, faceOptions_1.faceOption)
                            .withFaceLandmarks()
                            .withFaceDescriptors()];
                case 5:
                    results = _a.sent();
                    results.forEach(function (fd) {
